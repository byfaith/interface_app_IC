...
h4 = boxplot([unData(4,:)' unData(3,:)' unData(2,:)' ...
    unData(1,:)'], [0 2.5 5 7.5]', 'positions', pos1',...
    'colors', 'r','width',0.2);

hold on

h3 = boxplot([bmskData(4,:)' bmskData(3,:)' bmskData(2,:)' ...
    bmskData(1,:)'], [0 2.5 5 7.5]', 'positions', pos2',...
    'colors', 'g','width',0.2);

h2 = boxplot([wienerData(4,:)' wienerData(3,:)' wienerData(2,:)' ...
    wienerData(1,:)'], [0 2.5 5 7.5]', 'positions', pos3',...
    'colors', 'b','width',0.2);

h1 = boxplot([mmseData(4,:)' mmseData(3,:)' mmseData(2,:)' ...
    mmseData(1,:)'], [0 2.5 5 7.5]', 'positions', pos4',...
    'colors', 'k','width',0.2);
...
axis([-1 9 -10 100])
legend([h4(5,1),h3(5,1),h2(5,1),h1(5,1)], {'Não-processado','Máscara Binária',...
    'Wiener','MMSE'})
xlabel('SNR [dB]')
