...
% output filenames---------------------------------------------------------
NAMOUT_A  = 'Z-BinauralData_A_2.mat';   % data output file name
NAMOUT_B  = 'Z-BinauralData_B_2.mat';   % data output file name
NAMOUT_C  = 'Z-BinauralData_C_2.mat';   % data output file name
