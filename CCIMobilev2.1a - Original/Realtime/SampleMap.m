...
MAP.Left.StimulationRate    = 250;         % Stimulation rate per electrode in number of pulses per second (pps)
MAP.Left.PulseWidth         = 50;           % Pulse width in us
...
MAP.Left.ChannelOrderType   = 'apex-to-base'; % Channel Stimulation Order type: 'base-to-apex' or 'apex-to-base'
...
MAP.Right.StimulationRate   = 1100;             % Stimulation rate per electrode in number of pulses per second (pps)
