function [noisySignal, signalAdj, noiseAdj] = addnoise_asl_v2(cleanfile, fsclean, nbitsclean, noisefile, fsnoise, nbitsnoise, snr)
% ----------------------------------------------------------------------
...
% if IRS==1, clean= apply_IRS(cleanfile, fsclean, nbitsclean); end;
