function  [SNREst, SNRReal, MSEAvg, sigEstNoise, sigRelNoise, sigEstClean, sigRelEstClean, xfinal] = ics_constr_rule(x, cl, noise, Srate, outfile, GAIN, method, SNREstAl)
...
%
 % use noise estimation algorithm
    ...
    sigRelNoise = sum(noise_sign_mag2)/nFFT;
...
%                 postsnr = (sig2 ./ noise_mu2) ;  % a posteriori SNR
