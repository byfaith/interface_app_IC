...
%%%%%%%%%%%%%%%%%%%%% 
 ...
 a_post_snr = noisy_dft_frame_p./(noise_psd(1:end));%a posteriori SNR
if I==1,
   ...
   a_priori_snr=max(ALPHA*( clean_est_dft_frame_p(1:end))./(   noise_psd(1:end))+(1-ALPHA)*(a_post_snr-1),SNR_LOW_LIM);
end