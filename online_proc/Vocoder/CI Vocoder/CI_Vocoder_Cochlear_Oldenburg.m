function [vocoded_signal, mElectroderand] = CI_Vocoder_Cochlear_Oldenburg(signal,fs,vocoder_type, env, varargin)
% function [vocoded_signal, mElectroderand] = CI_Vocoder_Cochlear_Oldenburg(signal,fs,vocoder_type, env)
