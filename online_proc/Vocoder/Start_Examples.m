...
% [Original_Male, fs] = audioread('well-talk-about-it-soon.wav');
% [Original_Male, fs] = audioread('chirp_signal_0Hz_8000Hz.wav');
[Original_Male, fs] = audioread('F0002007.wav');
[Original_Female] = audioread('F0003003.wav');
...
[Vocoded_Male_Cochlear, electrodeband] = CI_Vocoder_Cochlear(Original_Male, fs, 'CI');
...
% Presentation = [Vocoded_Male_Cochlear'];
